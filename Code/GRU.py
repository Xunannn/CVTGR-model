...
from tensorflow.python.keras.layers import LSTM, Dropout, Dense, GRU
from tcn import TCN
...
model = Sequential()
model.add(GRU(units=64, input_shape=(1, train_X.shape[2])))
...
# values = inv_yhat
# # CSV文件路径
# csv_file = r'D:\MASTER\my_paper\paper_2\Result\GRU\Pre_Wuding.csv'
# # 将值显示在CSV文件的一列中
